...
export default {
  ...
  computed: {
    ...
    */
    ...
    ...mapGetters("userStore/userChild", [
      'GE_CHILD_NAME'
    ]),
  ...
  methods: {
    ...
    */
    ...
    searchName() {
      ...
      // this.$store.dispatch('userStore/AC_USER_NAME', payload);
      this.$store.commit('userStore/MU_USER_NAME', payload);
      console.log("SA 2");

      console.log("GE_CHILD_NAME=" + this.GE_CHILD_NAME);
      console.log("userName=" + this.$store.state.userStore.userName);
      console.log("childName=" + this.$store._state.data.userStore.userChild.childName);
      // console.log(JSON.stringify(this.$store));
      console.log("GE_USER_NAME=" + this.$store.getters['userStore/GE_USER_NAME'] );
      console.log("GE_CHILD_NAME=" + this.$store.getters['userStore/userChild/GE_CHILD_NAME'] );
      console.log("title=" + this.$store.getters['postStore/GE_POST_LIST'][0].title );
    }
  }
}
</script>